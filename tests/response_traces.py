...
def globally_causes():
    ...
    traces.append([
        ...
        BehaviourEvent(Point2D(x=1), MonitorState.SAFE),
        TriggerEvent(Point2D(x=1), MonitorState.ACTIVE),
        SpamEvent('a', Point2D(x=2)),
        BehaviourEvent(Point2D(x=1), MonitorState.SAFE),
...
def globally_causes_ref():
    ...
    traces.append([
        TriggerEvent(Point2D(x=1), MonitorState.ACTIVE),
        BehaviourEvent(Point2D(x=2), MonitorState.SAFE),
        SpamEvent('b', Point2D(x=2)),
    ])
    traces.append([
        TriggerEvent(Point2D(x=1), MonitorState.ACTIVE),
        TriggerEvent(Point2D(x=2), None),
        BehaviourEvent(Point2D(x=2), None),       # response to the first
        SpamEvent('b', Point2D(x=2)),
        TriggerEvent(Point2D(x=3), None),
        BehaviourEvent(Point2D(x=4), MonitorState.SAFE), # response to the remaining two
    ])
    # invalid
    # none, lol
    return (text, traces)
...
def globally_causes_within():
    ...
    traces.append([
        ...
        SpamEvent('b', Point2D()),
        SpamEvent('b', Point2D()),
        SpamEvent('b', Point2D(), state=MonitorState.FALSE),
        SpamEvent('b', Point2D(x=1)),
    ])
    return (text, traces)
...
def globally_causes_ref_within():
    ...
    traces.append([
        ...
        TriggerEvent(Point2D(x=3), None),
        BehaviourEvent(Point2D(x=4), MonitorState.SAFE),
    ])
    # invalid
    traces.append([
        TriggerEvent(Point2D(x=1), MonitorState.ACTIVE),
    ...
    traces.append([
        ...
        SpamEvent('b', Point2D(x=1)),
        SpamEvent('b', Point2D(x=1)),
        SpamEvent('b', Point2D(x=1), state=MonitorState.FALSE),
        SpamEvent('b', Point2D(x=2)),
    ])
    traces.append([
        TriggerEvent(Point2D(x=1), MonitorState.ACTIVE),
        ...
        SpamEvent('b', Point2D(x=2)),
        SpamEvent('b', Point2D(x=2)),
        SpamEvent('b', Point2D(x=2), state=MonitorState.FALSE),
...
def after_causes_ref():
    ...
    traces.append([
        ...
        TriggerEvent(Point2D(x=2), MonitorState.ACTIVE),
        SpamEvent('b', Point2D(x=2)),
        BehaviourEvent(Point2D(x=3), MonitorState.SAFE),
        TriggerEvent(Point2D(x=2), MonitorState.ACTIVE),
        TriggerEvent(Point2D(x=3), None),
        SpamEvent('b', Point2D(x=2)),
        BehaviourEvent(Point2D(x=4), MonitorState.SAFE),
...
def after_causes_within():
    ...
    traces.append([
        ...
        SpamEvent('b', Point2D(x=1)),
        SpamEvent('b', Point2D(x=1)),
        SpamEvent('b', Point2D(x=1), MonitorState.FALSE),
    ])
    traces.append([
        SpamEvent('b', Point2D()),
        TimerEvent(),
...
def after_causes_ref_within():
    ...
    traces.append([
        ...
        SpamEvent('b', Point2D()),
        SpamEvent('b', Point2D(x=1)),
        SpamEvent('b', Point2D(x=2), MonitorState.FALSE),
    ])
    traces.append([
        SpamEvent('b', Point2D()),
        TimerEvent(),
        ...
        TimerEvent(),
        SpamEvent('b', Point2D(x=2)),
        SpamEvent('b', Point2D(x=3), MonitorState.FALSE),
        TimerEvent(),
        SpamEvent('a', Point2D(x=2)),
        SpamEvent('b', Point2D(x=2)),
    ])
...
def until_causes():
    ...
    traces.append([
        TriggerEvent(Point2D(x=1), MonitorState.ACTIVE),
        TerminatorEvent(Point2D(x=1), MonitorState.FALSE),
    ])
    traces.append([
        SpamEvent('b', Point2D(x=1)),
        TimerEvent(),
...
def until_causes_ref():
    ...
    traces.append([
        ...
        TriggerEvent(Point2D(x=2), None),
        SpamEvent('b', Point2D(x=1)),
        BehaviourEvent(Point2D(x=2), None),
        BehaviourEvent(Point2D(x=3), MonitorState.SAFE),
        TriggerEvent(Point2D(x=1), MonitorState.ACTIVE),
        TriggerEvent(Point2D(x=2), None),
        TriggerEvent(Point2D(x=2), None),
...
def until_causes_within():
    ...
    traces.append([
        ...
        SpamEvent('b', Point2D(x=0)),
        SpamEvent('b', Point2D(x=0)),
        SpamEvent('b', Point2D(x=0), state=MonitorState.FALSE),
    ])
    return (text, traces)
...
def until_causes_ref_within():
    ...
    traces.append([
        ...
        BehaviourEvent(Point2D(x=2), None),
        SpamEvent('b', Point2D(x=3), state=MonitorState.FALSE),
        SpamEvent('q', Point2D(x=1)),
    ])
    traces.append([
        TriggerEvent(Point2D(x=1), MonitorState.ACTIVE),
...
def after_until_causes():
    ...
    traces.append([
        ActivatorEvent(Point2D(x=1), MonitorState.SAFE),
        TriggerEvent(Point2D(x=2), MonitorState.ACTIVE),
        TerminatorEvent(Point2D(x=2), MonitorState.FALSE),
    ])
    traces.append([
        SpamEvent('b', Point2D()),
        TimerEvent(),
    ...
    traces.append([
        ...
        ActivatorEvent(Point2D(x=2), MonitorState.SAFE),
        TriggerEvent(Point2D(x=3), MonitorState.ACTIVE),
        TerminatorEvent(Point2D(x=3), MonitorState.FALSE),
        SpamEvent('b', Point2D(x=3)),
        SpamEvent('q', Point2D(x=3)),
    ])
    traces.append([
...
def after_until_causes_ref():
    ...
    traces.append([
        ...
        TriggerEvent(Point2D(x=2), MonitorState.ACTIVE),
        TriggerEvent(Point2D(x=3), None),
        BehaviourEvent(Point2D(x=3), None),
        BehaviourEvent(Point2D(x=4), MonitorState.SAFE),
        SpamEvent('q', Point2D(x=1)),
        TerminatorEvent(Point2D(x=2), MonitorState.INACTIVE),
    ])
    ...
    traces.append([
        ...
        BehaviourEvent(Point2D(x=4), None),
        TerminatorEvent(Point2D(x=3), MonitorState.FALSE),
    ])
    return (text, traces)
...
def after_until_causes_ref_within():
    ...
    traces.append([
        ...
        SpamEvent('b', Point2D(x=3)),
        SpamEvent('b', Point2D(x=4)),
        SpamEvent('b', Point2D(x=5), state=MonitorState.FALSE),
        SpamEvent('a', Point2D(x=3)),
        SpamEvent('b', Point2D(x=3)),
        SpamEvent('q', Point2D(x=3)),
    ])
